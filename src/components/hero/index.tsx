...
const Hero = () => {
  const imgEsquerda = "https://cdn.midiamax.com.br/wp-content/uploads/2025/09/Novo-Projeto-23.webp";
  const imgTopoDireita = "https://viagemegastronomia.cnnbrasil.com.br/wp-content/uploads/sites/5/2022/10/BA_RA-HOTEL-4.jpg?w=1024";
  const imgBaixoDireita = "https://sportbuzz.com.br/wp-content/uploads/2025/07/6903630545_97b1d82be8_o-1-1-e1751914009132.jpg";

  return (
    <section className="w-full bg-gradient-to-br from-slate-50 to-blue-50 py-12 md:py-16 lg:py-20 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 md:gap-10 lg:gap-12 h-[550px] md:h-[650px] lg:h-[700px]">
          <div className="lg:col-span-3 relative rounded-2xl overflow-hidden shadow-2xl group cursor-pointer">
            <img
              src={imgEsquerda}
              alt="Jogador em ação"
            ...
            <div className="absolute inset-0 p-6 md:p-8 lg:p-10 flex flex-col justify-between">
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <p className="text-sm md:text-base lg:text-lg text-gray-200 leading-relaxed max-w-2xl">
                  André Pereira, do Brasil, foi convocado para substituir um jogador
                  lesionado. Agora, ganha oportunidade inédita de mostrar seu talento no cenário internacional.
                </p>
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6">
                  ...
                  <div className="flex items-center gap-4 md:gap-6 text-white/80">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-sm md:text-base font-medium">2.4k</span>
                    </div>
                    <div className="flex items-center gap-1.5">
                      <svg className="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <span className="text-sm md:text-base font-medium">Futebol</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute inset-0 p-4 md:p-6 lg:p-8 flex flex-col justify-between">
                ...
                <div className="space-y-2 md:space-y-3">
                  ...
                  <p className="text-xs md:text-sm lg:text-base text-gray-200 leading-relaxed">
                    Seleção terá hotel cinco estrelas em Rondonópolis. Quartos de luxo garantem conforto total.
                  </p>
                  <div className="flex items-center gap-3 md:gap-4 text-white/70">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs md:text-sm font-medium">890</span>
                    </div>
                    <span className="text-xs md:text-sm">•</span>
                    <span className="text-xs md:text-sm font-medium">Hotel</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl group cursor-pointer transform hover:scale-[1.02] transition-all duration-300">
              ...
              <div className="absolute inset-0 p-4 md:p-6 lg:p-8 flex flex-col justify-between">
                ...
                <div className="space-y-2 md:space-y-3">
                  ...
                  <p className="text-xs md:text-sm lg:text-base text-gray-200 leading-relaxed">
                    Torcedores rivais aumentam tensão. Mais de 100 seguranças estarão presentes.
                  </p>
                  <div className="flex items-center gap-3 md:gap-4 text-white/70">
                    <div className="flex items-center gap-1.5">
                      <svg className="w-3 h-3 md:w-4 md:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
